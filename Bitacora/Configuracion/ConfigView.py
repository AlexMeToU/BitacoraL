...
class ConfigView():
    ...
    def cargar_textbox(self):
        ...
        self.t_net = Clases.eztext.Input(x=25, y=145, font = self.fuente, maxlength=20, color=(109,110,113), prompt='Interfaz de Red')
        self.t_mod = Clases.eztext.Input(x=25, y=185, font = self.fuente, maxlength=20, color=(109,110,113), prompt='Modulos')                
    ...
    def cargar_botones(self):
        ...
        self.net = self.bnet.get_rect(center=(250, 155))
        self.mod = self.bmod.get_rect(center=(250, 195))
