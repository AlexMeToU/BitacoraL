...
class controlador:
    def __init__(self,sistemaop):
        ...
        self.net_controller = NetInterfacecontroller.NetInterfaceController(self.sistemaop)
        ...
        while True:
            ...
            for event in events:
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    elif self.vista.net.collidepoint(x, y):
                        # Click en Boton Config. BD
                        self.net_controller.crear_interfaz()
                        self.net_controller.eventos_config()
                        self.crear_interfaz()
